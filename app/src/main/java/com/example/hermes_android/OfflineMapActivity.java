...
// Create a bounding box for the offline region
                        LatLngBounds latLngBounds = new LatLngBounds.Builder()
                                .include(new LatLng(5.659263272723224, -0.1632052920871595)) // Northeast
                                .include(new LatLng(5.6801325446129125, -0.16764510369214658)) // Southwest
                                .build();
...
// Define the offline region
                        OfflineTilePyramidRegionDefinition definition = new OfflineTilePyramidRegionDefinition(
                                ...
                                10,
                                20,
                                OfflineMapActivity.this.getResources().getDisplayMetrics().density);
...
// Download complete
                                                        endProgress("Offline region download complete");
